...
namespace Prototype.NetworkLobby
{
    public class LobbyManager : NetworkLobbyManager 
    {
        ...
        //コネクションIDとキャラクターの位置を登録
        public void SetPlayer(NetworkConnection conn, int index)
        {
            if(currentPlayers.ContainsKey(conn.connectionId))
            {
                currentPlayers[conn.connectionId] = index;
        ...
        public override GameObject OnLobbyServerCreateGamePlayer(NetworkConnection conn, short playerControllerId)
        {
            ...
            GameObject playerPrefab = GameObject.Instantiate(spawnPrefabs[index], startPositions[Random.Range(0, startPositions.Count)].position, Quaternion.identity) as GameObject;
